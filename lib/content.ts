...
export const programPillars = [
  {
    number: "01",
    title: "Pemberdayaan Individu",
    subtitle: "Edukasi & Kapasitas",
    description: "Memperkuat pengetahuan, karakter, kepemimpinan, dan kapasitas diri perempuan serta generasi muda.",
    programs: ["Vanbucha Goes to School", "Bhavani Session"],
  },
  {
    number: "02",
    title: "Kolaborasi & Jejaring",
    subtitle: "Ruang Aman Komunitas",
    description: "Membangun ruang kolaboratif, jejaring lintas sektor, dan komunitas yang inklusif.",
    programs: ["Bhavani Bloom Festival", "Bhavani Connect"],
  },
  {
    number: "03",
    title: "Advokasi Berbasis Data",
    subtitle: "Perubahan Sistemik",
    description: "Menghasilkan kajian, literasi publik, dan rekomendasi untuk perubahan yang responsif terhadap isu perempuan.",
    programs: ["Riset Femisida", "Kajian Bicara Femisida"],
  },
];
...
export const flagshipPrograms = [
  {
    ...
    pillar: "Pemberdayaan Individu",
    title: "Vanbucha Goes to School",
    summary: "Program edukasi partisipatif bagi generasi muda untuk membangun kepemimpinan, karakter, kesadaran sosial, dan literasi digital.",
    details: ["SMAN 1 Kota Serang", "SMAN 1 Baros", "Kepemimpinan remaja", "Kesadaran gender"],
  },
  {
    slug: "bhavani-session",
    pillar: "Pemberdayaan Individu",
    title: "Bhavani Session",
    summary: "Diskusi dan edukasi digital melalui live streaming tentang perempuan, kesehatan mental, pendidikan, HAM, dan pengembangan kapasitas.",
    details: ["Kesehatan mental", "Literasi digital", "Kesetaraan gender", "Kepemimpinan muda"],
  },
  {
    slug: "bhavani-bloom-festival",
    pillar: "Kolaborasi & Jejaring",
    title: "Bhavani Bloom Festival",
    summary: "Festival pemberdayaan perempuan yang mempertemukan perempuan muda, komunitas, akademisi, praktisi, dan pemangku kepentingan.",
    details: ["Diskusi publik", "Sesi berbagi", "Networking", "Ruang aman"],
  },
  {
    slug: "bhavani-connect",
    pillar: "Kolaborasi & Jejaring",
    title: "Bhavani Connect",
    summary: "Forum dialog strategis bersama tokoh, akademisi, praktisi, dan pengambil kebijakan mengenai kepemimpinan dan pembangunan.",
    details: ["Kebijakan publik", "Kepemimpinan", "Lintas sektor", "Generasi muda"],
  },
  {
    slug: "riset-femisida",
    pillar: "Advokasi Berbasis Data",
    title: "Riset Femisida",
    summary: "Riset untuk memahami dinamika kekerasan terhadap perempuan dan menghasilkan publikasi serta rekomendasi kebijakan.",
    details: ["Kajian strategis", "Publikasi edukatif", "Rekomendasi kebijakan", "Literasi publik"],
  },
  {
    slug: "kajian-bicara-femisida",
    pillar: "Advokasi Berbasis Data",
    title: "Kajian Bicara Femisida",
    summary: "Forum publik yang membahas femisida melalui perspektif akademik, sosial, hukum, hak asasi manusia, dan pencegahan.",
    details: ["Kekerasan berbasis gender", "Perlindungan perempuan", "HAM", "Advokasi"],
  },
];
...
export const leadership = [
  ...
  ["Head of Curriculum & Training", "Khairunnisa"],
